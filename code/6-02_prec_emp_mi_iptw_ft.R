...
# 6-02 - IPTW for multiple imputed outcome models - full-time only 
# Andrew Pulford
...
#### load imputed data --------------------------------------------------------
imputed_data <- readRDS("./working_data/mi/imputed_data_ft.rds")
...
write_rds(weightit_df,"./working_data/mi/weightit_df_ft.rds")
