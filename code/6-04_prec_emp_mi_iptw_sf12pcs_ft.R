...
# 6-04 - IPTW multiple imputed outcome model (SF-12 PCS)  - full-time only
# Andrew Pulford
...
write.csv(weightit_pooled_pcs_df, "./working_data/mi/weightit_pooled_pcs_df_ft.csv")
write_rds(weightit_mods_pcs, "./working_data/mi/weightit_mods_pcs_ft.rds")
write_rds(weightit_pooled_pcs, "./working_data/mi/weightit_pooled_pcs_ft.rds")
