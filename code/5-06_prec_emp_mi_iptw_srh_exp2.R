...
# 5-06 - IPTW multiple imputed outcome model (Poor self-rated health) - alternate exposure definition 
# Andrew Pulford
...
write.csv(weightit_pooled_srh_df, "./working_data/mi/weightit_pooled_srh_df_exp2.csv")
