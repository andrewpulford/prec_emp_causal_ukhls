...
# check
sapply(df_o, function(x) sum(is.na(x)))
...
df_o_str$method[df_o_str$Var1=="sex_bin"] <- "pmm"
...
df_o_str$method[df_o_str$Var1=="rel_pov_bin"] <- "pmm"
...
df_o_str$method[df_o_str$Var1=="sex_pcs"] <- "~I(sex_bin*(sf12pcs_dv_t1-mean(sf12pcs_dv_t1)))"
df_o_str$method[df_o_str$Var1=="sex_mcs"] <- "~Isf12pcs_dv_t1-mean(sf12mcs_dv_t1, na.rm = TRUE)))"
df_o_str$method[df_o_str$Var1=="sex_srh"] <- "~I(sex_bin*srh_bin2)"
df_o_str$method[df_o_str$Var1=="sex_ghq"] <- "~I(sex_bin*ghq_bin)"
df_o_str$method[df_o_str$Var1=="age_pcs"] <- "~I(age_bin*sf12pcs_dv_t1-mean(sf12pcs_dv_t1, na.rm = TRUE)))"
df_o_str$method[df_o_str$Var1=="age_mcs"] <- "~I(age_bin*sf12mcs_dv_t1-mean(sf12pcs_dv_t1, na.rm = TRUE)))"
df_o_str$method[df_o_str$Var1=="age_srh"] <- "~I(age_bin*srh_bin2)"
df_o_str$method[df_o_str$Var1=="age_ghq"] <- "~I(age_bin*ghq_bin)"
df_o_str$method[df_o_str$Var1=="rel_pov_pcs"] <- "~I(rel_pov_bin*sf12pcs_dv_t1-mean(sf12pcs_dv_t1, na.rm = TRUE)))"
df_o_str$method[df_o_str$Var1=="rel_pov_mcs"] <- "~I(rel_pov_bin*sf12mcs_dv_t1-mean(sf12pcs_dv_t1, na.rm = TRUE)))"
df_o_str$method[df_o_str$Var1=="rel_pov_srh"] <- "~I(rel_pov_bin*srh_bin2)"
df_o_str$method[df_o_str$Var1=="rel_pov_ghq"] <- "~I(rel_pov_bin*ghq_bin)"
