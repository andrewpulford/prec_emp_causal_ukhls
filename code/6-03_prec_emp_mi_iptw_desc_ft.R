...
# 6-03 -  Descriptive analysis for IPTW multiple imputed outcome models - full-time only 
# Andrew Pulford
...
#### load imputed data --------------------------------------------------------
weightit_df <- readRDS("./working_data/mi/weightit_df_ft.rds")
...
tiff("./output/mi/mi_descriptives/iptw_love_plot_ft.tiff", width = 980)
...
pdf("./output/mi/mi_descriptives/iptw_love_plot_ft.pdf", width = 980, height = 980)
love.plot(weightit_df, thresholds = 0.1, stats = "m",
          drop.distance = TRUE, binary = "std", continuous = "std",
          sample.names = c("Unweighted","Inverse probability of treatment weighted")) 
# var.names() - to clean up names
...
### create table one
table_one <- svyCreateTableOne(vars = c(cov_vector, "sex_bin", "rel_pov_bin"),
...
write.csv(table_one_sav, "./output/mi/sensitivity_analyses/full-time/weighted_descriptives/table_one_unpooled_ft.csv")
...
write.csv(outcomes_desc_sav, "./output/mi/sensitivity_analyses/full-time/weighted_descriptives/outcomes_desc_ft.csv")

################################################################################
#####                           sort out table 1                           #####
################################################################################

table_one_sav <- read.csv("./output/mi/sensitivity_analyses/full-time/weighted_descriptives/table_one_unpooled_ft.csv")
...
write.csv(table_one_sav, "./output/mi/sensitivity_analyses/full-time/weighted_descriptives/table_one_PAPER_ft.csv")
