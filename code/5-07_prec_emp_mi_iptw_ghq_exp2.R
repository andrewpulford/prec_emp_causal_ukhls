...
# 5-07 - IPTW multiple imputed outcome model (GHQ-12 caseness) - alternate exposure definition 
# Andrew Pulford
...
write.csv(weightit_pooled_ghq_df, "./working_data/mi/weightit_pooled_ghq_df_exp2.csv")
