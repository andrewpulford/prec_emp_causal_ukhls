...
# 6-01 - Create multiple imputed analytic sample - full-time only
# Andrew Pulford
...
write_rds(mi_subset2, "./working_data/mi/mi_subset2_ft.rds")
...
write_csv(temp3, "./output/temp_output/temp3_micheck_ft.csv")

## check NAs
sapply(complete(imps2,2), function(x) sum(is.na(x)))

#### save imputed data 
write_rds(imps2, "./working_data/mi/imputed_data_ft.rds")
