...
# 5-05 - IPTW multiple imputed outcome model (SF-12 MCS) - alternate exposure definition 
# Andrew Pulford
...
write.csv(weightit_pooled_mcs_df, "./working_data/mi/weightit_pooled_mcs_df_exp2.csv")
