...
df_y_str$method[df_y_str$Var1=="sex_mcs"] <- "~I(sex_dv_t0*(sf12mcs_dv_t1-mean(sf12mcs_dv_t1)))"
df_y_str$method[df_y_str$Var1=="sex_srh"] <- "~I(sex_dv_t0*srh_bin2)"
df_y_str$method[df_y_str$Var1=="sex_ghq"] <- "~I(sex_dv_t0*ghq_bin)"
df_y_str$method[df_y_str$Var1=="age_pcs"] <- "~I(age_dv_t0*(sf12pcs_dv_t1-mean(sf12pcs_dv_t1)))"
df_y_str$method[df_y_str$Var1=="age_mcs"] <- "~I(age_dv_t0*(sf12mcs_dv_t1-mean(sf12mcs_dv_t1)))"
df_y_str$method[df_y_str$Var1=="age_srh"] <- "~I(age_dv_t0*srh_bin2)"
df_y_str$method[df_y_str$Var1=="age_ghq"] <- "~I(age_dv_t0*ghq_bin)"
df_y_str$method[df_y_str$Var1=="rel_pov_pcs"] <- "~I(rel_pov_t0*(sf12pcs_dv_t1-mean(sf12pcs_dv_t1)))"
df_y_str$method[df_y_str$Var1=="rel_pov_mcs"] <- "~I(rel_pov_t0*(sf12mcs_dv_t1-mean(sf12mcs_dv_t1)))"
