...
### in relative poverty
df_rel_pov <- subset(mi_subset2, mi_subset2$rel_pov_bin==1)
...
# check
sapply(df_rel_pov, function(x) sum(is.na(x)))
...
df_rel_pov_str$method[df_rel_pov_str$Var1=="sex_bin"] <- "pmm"
...
df_rel_pov_str$method[df_rel_pov_str$Var1=="rel_pov_bin"] <- "pmm"
...
df_rel_pov_str$method[df_rel_pov_str$Var1=="sex_pcs"] <- "~I(sex_bin*(sf12pcs_dv_t1-mean(sf12pcs_dv_t1)))"
df_rel_pov_str$method[df_rel_pov_str$Var1=="sex_mcs"] <- "~Isf12pcs_dv_t1-mean(sf12mcs_dv_t1, na.rm = TRUE)))"
df_rel_pov_str$method[df_rel_pov_str$Var1=="sex_srh"] <- "~I(sex_bin*srh_bin2)"
df_rel_pov_str$method[df_rel_pov_str$Var1=="sex_ghq"] <- "~I(sex_bin*ghq_bin)"
df_rel_pov_str$method[df_rel_pov_str$Var1=="age_pcs"] <- "~I(age_bin*sf12pcs_dv_t1-mean(sf12pcs_dv_t1, na.rm = TRUE)))"
df_rel_pov_str$method[df_rel_pov_str$Var1=="age_mcs"] <- "~I(age_bin*sf12mcs_dv_t1-mean(sf12pcs_dv_t1, na.rm = TRUE)))"
df_rel_pov_str$method[df_rel_pov_str$Var1=="age_srh"] <- "~I(age_bin*srh_bin2)"
df_rel_pov_str$method[df_rel_pov_str$Var1=="age_ghq"] <- "~I(age_bin*ghq_bin)"
df_rel_pov_str$method[df_rel_pov_str$Var1=="rel_pov_pcs"] <- "~I(rel_pov_bin*sf12pcs_dv_t1-mean(sf12pcs_dv_t1, na.rm = TRUE)))"
df_rel_pov_str$method[df_rel_pov_str$Var1=="rel_pov_mcs"] <- "~I(rel_pov_bin*sf12mcs_dv_t1-mean(sf12pcs_dv_t1, na.rm = TRUE)))"
df_rel_pov_str$method[df_rel_pov_str$Var1=="rel_pov_srh"] <- "~I(rel_pov_bin*srh_bin2)"
df_rel_pov_str$method[df_rel_pov_str$Var1=="rel_pov_ghq"] <- "~I(rel_pov_bin*ghq_bin)"
